...
function StudentDetailPage() {
  ...
  return (
    <>
      <SEO 
        title={`${student.full_name} | Professional Profile | GetJobAndGo`}
        description={`View the professional profile and skills of ${student.full_name} on GetJobAndGo. Connect with verified talent.`}
        canonical={`https://getjobandgo.com/students/${id}`}
        schema={{
          ...
          "address": {
            "@type": "PostalAddress",
            "addressLocality": student.district,
            "addressRegion": student.state,
            "addressCountry": student.country || "India"
          }
        }}
      />
