    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-xs text-slate-400">
          Use your registered email to access your applications and profile.
        </p>
      </div>
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="mt-4 text-center">
          <p className="text-xs text-slate-400">
            ...
            <Link to="/auth/register" className="text-primary-400 font-medium hover:text-primary-300 transition-colors">
              Register here
            </Link>
          </p>
          <div className="mt-2 text-center text-xs text-slate-500">
             <Link to="/auth/company/login" className="hover:text-slate-300 underline underline-offset-2">Go to Company Portal</Link>
          </div>
        </div>
      </form>
    </div>
