...
import { getCompanyProfile, updateCompany } from '../../services/companyService';
...
function CompanyProfilePage() {
  ...
  if (!profileId) {
    return (
      <div className="flex justify-center p-8">
        <p className="text-sm text-slate-400 font-medium">Profile data not found.</p>
      </div>
    );
  }
  ...
  return (
    <>
      <SEO 
        title="Organization Settings | Profile | GetJobAndGo"
        description="Update your company profile, logo, and hiring information to attract top talent on GetJobAndGo."
        canonical="https://getjobandgo.com/company/profile"
      />
