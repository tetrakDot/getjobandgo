...
function HomePage() {
  ...
  return (
    <>
      <SEO
        title="GetJobAndGo | Find Jobs & Hire Talent in India"
        description="GetJobAndGo connects students and companies. Find jobs, internships, and hire top talent across India."
        ...
        <main className="relative">
          ...
          <section className="max-w-4xl mx-auto px-6 pt-24 pb-16 text-center">
            ...
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-serif leading-[1.1] mb-6 tracking-tight">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-400 to-logoGreen italic">
                Freshers & Interns
              </span>
            </h1>
            ...
            <p className="text-base text-primary-200/80 mb-12 max-w-2xl mx-auto font-medium">
              ...
              செய்யப்பட்ட நிறுவனங்கள் மற்றும் employees மட்டும் இணையும்
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              {!user && (
                <>
                  <Link
                    to="/auth/register"
                    className="w-full sm:w-auto px-8 py-3.5 rounded-xl bg-primary-600 text-white font-medium hover:bg-primary-500 transition-all shadow-lg shadow-primary-500/25 flex items-center justify-center gap-2"
                  >
                    <User className="w-5 h-5" /> I'm a Student
                  </Link>
                  <Link
                    to="/auth/company/register"
                    className="w-full sm:w-auto px-8 py-3.5 rounded-xl bg-slate-800 text-white font-medium hover:bg-slate-700 border border-slate-700 transition-all flex items-center justify-center gap-2"
                  >
            ...
            <div className="max-w-5xl mx-auto px-6 py-20">
              <div className="text-center mb-16">
                ...
                <p className="text-slate-300 max-w-2xl mx-auto">
                  We empower freshers and interns by providing genuine, verified
                  job opportunities. Our goal is to eliminate fake accounts and
                  build a transparent hiring system.
                  <br />
                  <br />
                  <span className="text-slate-400 text-sm">
                    Fake accounts இல்லாமல், verified வேலை வாய்ப்புகளை வழங்கி
                    freshers மற்றும் interns க்கு நம்பகமான சூழலை உருவாக்குவது
                    எங்கள் குறிக்கோள்.
                  </span>
                </p>
              </div>
              ...
              <div className="grid md:grid-cols-3 gap-6">
                ...
                <div className="bg-slate-900/80 border border-slate-800 rounded-2xl p-6 text-center">
                  ...
                  <p className="text-slate-400 text-sm mb-3">
                    A secure and reliable ecosystem for your career growth.
                  </p>
                  <p className="text-slate-500 text-xs">
                    உங்கள் வேலைவாய்ப்பு பயணத்திற்கான ஒரு பாதுகாப்பான தளம்.
                  </p>
                </div>
              </div>
            </div>
          ...
          <section className="py-20 text-center px-6">
            ...
            <p className="text-xl text-primary-100 max-w-2xl mx-auto mb-4 font-serif italic">
              "Make it easy for everyone to Get a Job and Go to the next chapter
              of their life."
            </p>
            <p className="text-slate-400 text-sm">
              ஒவ்வொருவரும் எளிதாக ஒரு வேலை பெற்று, வாழ்க்கையின் அடுத்த
